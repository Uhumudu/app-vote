...
// ✅ FIX : montant harmonisé à 10 XAF
const FRAIS_ELECTION = 10;
...
export default function CreerElection() {
  ...
  const handlePayer = async () => {
    ...
    try {
      ...
      // ✅ FIX : Upload photo AVANT d'envoyer les données de l'élection
      let photoUrl = null;
      if (photoFile) {
      ...
      // ✅ FIX : photoUrl incluse dans donnees_election pour que le backend l'enregistre
      const { data } = await api.post("/campay/initier-paiement", {
        ...
        donnees_election: {
          ...
          photoUrl,          // ✅ transmis au backend dans donnees_election
        },
      });
