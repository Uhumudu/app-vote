...
//               onChange={handleChange} disabled={!isEditable} rows="4"
...
//               <div>
//                 <label className="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1.5 flex items-center gap-1.5">
//                   <FiClock size={12} className="text-indigo-500" /> Durée par tour *
//                 </label>
//                 <select
...
//                       <span className="font-semibold text-indigo-700">
//                         {new Date(formData.startDate).toLocaleString("fr-FR", {
...
//                   Si aucune liste n'obtient la majorité absolue (&gt; 50%), un nouveau tour s'ouvre automatiquement avec la même durée.
//                 </p>
//               </div>
//             </div>
//           )}
