...
//           <img src={Election} alt="Création d'élection" className="rounded-2xl"/>
//         </div>
...
//             {/* ADMIN */}
//             <section>
//               <h3 className="font-semibold mb-4 text-black">Informations du créateur</h3>
...
//                 <Input type="password" name="motDePasse" value={formData.motDePasse} onChange={handleChange} placeholder="Mot de passe"/>
//               </div>
//             </section>

//             {/* ÉLECTION */}
//             <section>
//               <h3 className="font-semibold mb-4 text-black">Informations de l’élection</h3>
...
//                 <div>
//                   <label className="block mb-2 font-medium">Date et heure de début</label>
//                   <Input type="datetime-local" name="startDate" value={formData.startDate} onChange={handleChange}/>
//                 </div>

//                 <div>
//                   <label className="block mb-2 font-medium">Date et heure de fin</label>
//                   <Input type="datetime-local" name="endDate" value={formData.endDate} onChange={handleChange}/>
//                 </div>

//                 <Select name="electionType" value={formData.electionType} onChange={handleChange}>
//                   <option value="">Type de scrutin</option>
//                   <option value="UNINOMINAL">Uninominal</option>
//                   <option value="BINOMINAL">Binominal</option>
//                   <option value="LISTE">Liste</option>
//                 </Select>
...
//               className="w-full h-28 px-4 py-3 border rounded-xl"
//             />
...
// function Select({ children, name, value, onChange }) {
//   return (
//     <select
//       name={name}
//       value={value}
