...
// import {
//   FiUser, FiMail, FiLock, FiCalendar, FiList,
//   FiAlignLeft, FiCheckCircle, FiArrowRight, FiType, FiClock, FiInfo
// } from "react-icons/fi";
// import api from "../../../services/api";
// import Election from './elct.webp';
...
//     setFormData(prev => ({
//       ...prev,
//       [name]: name === "dureeTourMinutes" ? parseInt(value) : value,
//     }));
//   };
...
//     // Validation date fin uniquement pour non-LISTE
//     if (!isListe && new Date(formData.endDate) <= new Date(formData.startDate)) {
//       alert("La date de fin doit être supérieure à la date de début !");
//       return;
//     }
...
//       // Pour LISTE : date_fin calculée = startDate + dureeTourMinutes
//       const endDate = isListe
//         ? new Date(new Date(formData.startDate).getTime() + formData.dureeTourMinutes * 60000)
//             .toISOString().slice(0, 16)
//         : formData.endDate;
...
//   // Aperçu fin du Tour 1 pour scrutin LISTE
//   const dateFinTour1 = isListe && formData.startDate
//     ? new Date(new Date(formData.startDate).getTime() + formData.dureeTourMinutes * 60000)
//         .toLocaleString("fr-FR", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit" })
//     : null;
...
//                         {dateFinTour1 && (
//                           <div className="apercu-box">
//                             <p className="apercu-title"><span className="apercu-icon">📅</span> Aperçu du calendrier</p>
//                             <div className="apercu-row">
//                               <span>Début Tour 1</span>
//                               <span className="apercu-val">
//                                 {new Date(formData.startDate).toLocaleString("fr-FR", { day: "2-digit", month: "2-digit", year: "numeric", hour: "2-digit", minute: "2-digit" })}
...
//                             <div className="apercu-row apercu-row--muted">
//                               <span>Tours suivants</span>
//                               <span>+{DUREE_OPTIONS.find(o => o.value === formData.dureeTourMinutes)?.label} après résultats</span>
//                             </div>
//                           </div>
//                         )}
...
//                         <div className="info-box">
//                           <FiInfo size={13} style={{ flexShrink: 0, marginTop: 1 }} />
//                           <p>Si aucune liste n'obtient la majorité absolue (&gt; 50%), un nouveau tour s'ouvre automatiquement avec la même durée. Les listes sous 5% sont éliminées.</p>
//                         </div>
//                       </div>
//                     )}
...
//     transition: background .15s, transform .15s; font-family: 'Outfit', sans-serif;
//   }
//   .nav-btn-ghost:hover { background: var(--indigo-50); transform: translateY(-1px); }
//   .nav-btn-filled {
...
//     background: var(--indigo-600); box-shadow: 0 4px 12px rgba(79,70,229,0.28);
//     transition: background .18s, transform .15s, box-shadow .18s; font-family: 'Outfit', sans-serif;
//   }
//   .nav-btn-filled:hover { background: var(--indigo-700); transform: translateY(-1px); box-shadow: 0 6px 18px rgba(79,70,229,0.35); }
...
//     color: white; padding: 5px 16px; border-radius: 999px; font-size: 12px; font-weight: 600;
...
//     font-size: 11.5px; font-weight: 600; letter-spacing: .6px; text-transform: uppercase; margin-bottom: 10px;
//   }
//   .form-title { font-size: 26px; font-weight: 800; color: var(--indigo-900); letter-spacing: -0.5px; margin-bottom: 6px; }
//   .form-subtitle { font-size: 14px; color: var(--gray-500); }
...
//   }
//   .apercu-icon { font-size: 14px; }
//   .apercu-row {
//     display: flex; justify-content: space-between; align-items: center;
//     font-size: 12.5px; color: var(--gray-500);
//   }
//   .apercu-row--muted { opacity: 0.65; }
//   .apercu-val { font-weight: 600; color: var(--indigo-700); }
//   .apercu-val--accent { color: var(--indigo-600); }
...
//     font-size: 12.5px; color: var(--amber-600); line-height: 1.6;
//   }
...
//     padding: 12px 28px; background: var(--indigo-600); color: white; text-decoration: none;
//     border-radius: 11px; font-size: 14.5px; font-weight: 600; font-family: 'Outfit', sans-serif;
//     box-shadow: 0 4px 14px rgba(79,70,229,0.28); transition: background .18s, transform .15s;
//   }
//   .success-btn:hover { background: var(--indigo-700); transform: translateY(-1px); }
