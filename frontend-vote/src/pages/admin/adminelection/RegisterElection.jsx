...
//     },
//     {
//       value: "PUBLIQUE",     // ✅ corrigé : était "PUBLIC"
//       icon: <FiGlobe size={18} />,
//       label: "🌍 Publique",
//       desc: "Visible sur la page d'accueil — candidatures & votes ouverts à tous",
//       color: "#0ea5e9",
...
//               fontWeight: 800,
//               fontSize: "13.5px",
//               color: value === opt.value ? opt.color : "#374151",
//             }}>
//               {opt.label}
//             </p>
//             <p style={{ margin: 0, fontSize: "11.5px", color: "#6b7280", lineHeight: 1.5 }}>
...
//     nbSieges: 29,
//     description: "",
//     visibilite: "PRIVE",  // valeur par défaut inchangée (PRIVE est correct)
//   });
...
//     setFormData(prev => ({ ...prev, visibilite: val }));
//   };
...
//                   </div>
//                   <div className="fields-grid-2">
//                     <Field icon={<FiUser size={15}/>}  label="Nom" name="nom" value={formData.nom} onChange={handleChange} placeholder="ctec" focused={focused} setFocused={setFocused}/>
//                     <Field icon={<FiUser size={15}/>}  label="Prénom" name="prenom" value={formData.prenom} onChange={handleChange} placeholder="sarl" focused={focused} setFocused={setFocused} />
//                     <Field icon={<FiMail size={15}/>}  label="Email" name="email" value={formData.email} onChange={handleChange} placeholder="ctectsarl@gmail.com" focused={focused} setFocused={setFocused} type="email" />
//                     <Field icon={<FiLock size={15}/>}  label="Mot de passe" name="motDePasse" value={formData.motDePasse} onChange={handleChange} placeholder="••••••••" focused={focused} setFocused={setFocused} type="password" />
//                   </div>
//                 </div>
