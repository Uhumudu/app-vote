...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 08 avr. 2026 à 22:57
...
(81, 'pont luner', NULL, NULL, 43, NULL, NULL),
(82, 'drers afred', NULL, NULL, 43, NULL, NULL),
(83, 'liner pedro', NULL, NULL, 47, NULL, NULL);

-- --------------------------------------------------------

--
-- Structure de la table `candidat_public`
--

DROP TABLE IF EXISTS `candidat_public`;
CREATE TABLE IF NOT EXISTS `candidat_public` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_candidat_public_election` (`election_id`),
  KEY `fk_candidat_public_user` (`utilisateur_id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Déchargement des données de la table `candidat_public`
--

INSERT INTO `candidat_public` (`id`, `election_id`, `nom`, `prenom`, `email`, `telephone`, `bio`, `photo_url`, `statut`, `created_at`, `utilisateur_id`) VALUES
(1, 43, 'luner', 'pont', 'luner@gmail.com', '655024817', 'ERTYUIH', NULL, 'APPROUVE', '2026-04-03 04:18:25', NULL),
(2, 43, 'lerter', 'kutur', 'lerter@gmail.com', '634025716', 'DFGHJKLERTYUIKJHJK', NULL, 'REJETE', '2026-04-03 05:20:07', NULL),
(3, 43, 'afred', 'drers', 'afred@gmail.com', '655024813', 'DFGHJ', NULL, 'APPROUVE', '2026-04-05 07:49:57', NULL),
(4, 47, 'pedro', 'liner', 'pedro@gmail.com', '690265443', 'SR', NULL, 'APPROUVE', '2026-04-06 00:16:40', 100);
...
CREATE TABLE IF NOT EXISTS `election` (
  ...
  `visibilite` enum('PUBLIQUE','PRIVEE') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'PRIVEE',
  `admin_id` int NOT NULL,
  `tour_courant` int DEFAULT '1',
  `nb_sieges` int DEFAULT '0',
  `duree_tour_minutes` int DEFAULT '1440',
  `frais_vote_xaf` int DEFAULT NULL COMMENT 'Frais en XAF pour voter (null = gratuit/privé)',
  `photo_url` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id_election`),
  KEY `admin_id` (`admin_id`),
  KEY `idx_election_visibilite` (`visibilite`,`statut`)
...
INSERT INTO `election` (`id_election`, `titre`, `description`, `date_debut`, `date_fin`, `statut`, `visibilite`, `admin_id`, `tour_courant`, `nb_sieges`, `duree_tour_minutes`, `frais_vote_xaf`, `photo_url`) VALUES
(31, 'Monstral Election', 'GDGDJD', '2026-03-28 13:00:00', '2026-03-28 14:00:00', 'SUSPENDUE', 'PRIVEE', 89, 1, NULL, NULL, NULL, NULL),
(4, 'Election juge general', 'IL s\'agit de voté le juge principal et son vice', '2026-03-06 12:00:00', '2026-03-09 21:00:00', 'TERMINEE', 'PRIVEE', 28, 1, 0, 1440, NULL, NULL),
(30, 'MONTE ELECTION', 'AZERTYU', '2026-03-28 12:00:00', '2026-03-28 13:00:00', 'SUSPENDUE', 'PRIVEE', 88, 1, NULL, NULL, NULL, NULL),
(6, 'Election du minsboys', 'Vots un bureau', '2026-03-09 11:00:00', '2026-03-11 13:00:00', 'SUSPENDUE', 'PRIVEE', 30, 1, 0, 1440, NULL, NULL),
(7, 'election ISMA', 'whaouuuuu c\'est bien', '2026-03-15 11:00:00', '2026-03-16 12:00:00', 'TERMINEE', 'PRIVEE', 31, 1, 0, 1440, NULL, NULL),
(8, 'election DOCTOR', 'Elu le docteur principal de l\'hopital central', '2026-03-15 12:00:00', '2026-03-16 13:00:00', 'TERMINEE', 'PRIVEE', 31, 1, 0, 1440, NULL, NULL),
(28, 'ABIR ELECTION', 'AZERTYU', '2026-03-28 12:00:00', '2026-03-28 13:00:00', 'SUSPENDUE', 'PRIVEE', 86, 1, NULL, NULL, NULL, NULL),
(29, 'PISTE ELECTION', 'AZERTYU', '2026-03-28 12:00:00', '2026-03-28 13:00:00', 'SUSPENDUE', 'PRIVEE', 87, 1, NULL, NULL, NULL, NULL),
(10, 'Elire Meilleur milieu', 'election du milieu le plus prolifique de tout les temps', '2026-03-12 11:45:00', '2026-03-12 12:00:00', 'TERMINEE', 'PRIVEE', 37, 1, 0, 1440, NULL, NULL),
(11, 'Election messi ou ronaldo ', 'voter le joueur le plus fort entre messi et ronaldo', '2026-03-12 13:03:00', '2026-03-12 14:00:00', 'TERMINEE', 'PRIVEE', 37, 1, 0, 1440, NULL, NULL),
(12, 'Election Liste Test', 'Cette election est faite pour voir si l\'election de type liste fonctionne correctement', '2026-03-15 14:00:00', '2026-03-15 20:00:00', 'TERMINEE', 'PRIVEE', 44, 1, 6, 360, NULL, NULL),
(23, 'Election Pont', 'GGZJ', '2026-03-26 23:03:00', '2026-03-26 23:20:00', 'SUSPENDUE', 'PRIVEE', 81, 1, NULL, NULL, NULL, NULL),
(25, 'Moussa', 'hjkk', '2026-03-28 12:00:00', '2026-03-28 14:00:00', 'SUSPENDUE', 'PRIVEE', 25, 1, NULL, NULL, NULL, NULL),
(17, 'ELECTION UNINOMINALE', 'Pour faire les tests pour voir si le scrutin uninominal fonctionne coorectement', '2026-03-26 13:10:00', '2026-03-26 13:20:00', 'TERMINEE', 'PRIVEE', 25, 1, NULL, NULL, NULL, NULL),
(20, 'Election de teEt listes', 'pour tester la liste ', '2026-03-24 23:55:00', '2026-03-25 01:15:00', 'TERMINEE', 'PRIVEE', 25, 4, 7, 60, NULL, NULL),
(32, 'Monstral Election', 'GDGDJD', '2026-03-28 14:00:00', '2026-03-28 15:00:00', 'SUSPENDUE', 'PRIVEE', 89, 1, 0, 1440, NULL, NULL),
(34, 'Election jury', 'DGHJKLLXHYUI', '2026-03-29 18:00:00', '2026-03-29 21:00:00', 'TERMINEE', 'PRIVEE', 91, 1, NULL, NULL, NULL, NULL),
(35, 'Election jury', 'DGHJKLLXHYUI', '2026-03-29 18:00:00', '2026-03-29 21:00:00', 'TERMINEE', 'PRIVEE', 92, 1, NULL, NULL, NULL, NULL),
(36, 'Election jury', 'DGHJKLLXHYUI', '2026-03-29 20:00:00', '2026-03-29 23:00:00', 'SUSPENDUE', 'PRIVEE', 92, 1, 0, 1440, NULL, NULL),
(37, 'Voter compagnies', 'ZERTYU', '2026-03-30 13:00:00', '2026-03-30 15:00:00', 'SUSPENDUE', 'PRIVEE', 93, 1, NULL, NULL, NULL, NULL),
(38, 'Voter compagnies', 'ZERTYU', '2026-03-30 13:00:00', '2026-03-30 15:00:00', 'SUSPENDUE', 'PRIVEE', 94, 1, NULL, NULL, NULL, NULL),
(39, 'ELECTION MEMBRE', 'SDFGHJK', '2026-03-30 09:00:00', '2026-03-30 12:00:00', 'SUSPENDUE', 'PUBLIQUE', 95, 1, NULL, NULL, NULL, NULL),
(40, 'ELECTION MEMBRE', 'SDFGHJK', '2026-03-30 11:00:00', '2026-03-30 14:00:00', 'TERMINEE', 'PUBLIQUE', 95, 1, 0, 1440, NULL, NULL),
(41, 'TACKU ELECTION', 'RTYU', '2026-03-30 13:00:00', '2026-03-30 16:00:00', 'TERMINEE', 'PUBLIQUE', 96, 1, NULL, NULL, NULL, NULL),
(42, 'TACKU ELECTION', 'RTYU', '2026-03-30 15:00:00', '2026-03-30 18:00:00', 'SUSPENDUE', 'PUBLIQUE', 96, 1, 0, 1440, NULL, NULL),
(43, 'Election were', 'SHDHJD', '2026-04-04 13:00:00', '2026-04-06 10:00:00', 'TERMINEE', 'PUBLIQUE', 97, 1, NULL, NULL, NULL, NULL),
(44, 'Election were', 'SHDHJD', '2026-04-04 15:00:00', '2026-04-06 12:00:00', 'SUSPENDUE', 'PUBLIQUE', 97, 1, 0, 1440, NULL, NULL),
(45, 'MIX CAMEROUN', 'Election qui consiste a voter le meilleur mix du cameroun', '2026-04-06 13:00:00', '2026-04-08 10:00:00', 'SUSPENDUE', 'PRIVEE', 98, 1, NULL, NULL, NULL, NULL),
(47, 'MASTER CAMEROUN', 'Voter master du cameroun', '2026-04-07 12:00:00', '2026-04-09 20:00:00', 'EN_COURS', 'PUBLIQUE', 99, 1, NULL, NULL, NULL, '/uploads/ctecsarl.JPG');
...
(9, 0, 'PLATFORM_CONFIG', '{\"nomPlateforme\":\"EvotePlus1\",\"urlFrontend\":\"https://localhost:5173\",\"emailSupport\":\"evoteplus1@gmail.com\",\"votesMultiples\":false,\"inscriptionOuverte\":true,\"maintenance\":false,\"dureeSession\":\"24\",\"couleurPrincipale\":\"#48e5d3\",\"logoUrl\":\"/uploads/photo-1775671026547.jpg\",\"messageMaintenance\":\"La plateforme est temporairement indisponible pour maintenance. Veuillez réessayer ultérieurement.\"}', '2026-04-08 17:59:14');
...
(35, 'UNINOMINAL', NULL, 37),
(36, 'UNINOMINAL', NULL, 38),
(37, 'UNINOMINAL', NULL, 39),
(38, 'UNINOMINAL', NULL, 40),
(39, 'UNINOMINAL', NULL, 41),
(40, 'UNINOMINAL', NULL, 42),
(41, 'UNINOMINAL', NULL, 43),
(42, 'UNINOMINAL', NULL, 44),
(43, 'UNINOMINAL', NULL, 45),
(45, 'UNINOMINAL', NULL, 47);
...
CREATE TABLE IF NOT EXISTS `tour_election` (
  ...
  `statut` enum('EN_COURS','TERMINE','GAGNANT_TROUVE') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'EN_COURS',
...
CREATE TABLE IF NOT EXISTS `transaction_paiement` (
  ...
  `admin_id` int NOT NULL,
  `campay_reference` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `external_reference` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `montant` int NOT NULL DEFAULT '500',
  `statut` enum('PENDING','SUCCESSFUL','FAILED') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT 'PENDING',
  `donnees_election` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `date_creation` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  `date_confirmation` timestamp NULL DEFAULT NULL,
  `type_transaction` varchar(50) COLLATE utf8mb4_unicode_ci DEFAULT 'CREATION_ELECTION',
...
INSERT INTO `transaction_paiement` (`id_transaction`, `admin_id`, `campay_reference`, `external_reference`, `montant`, `statut`, `donnees_election`, `date_creation`, `date_confirmation`, `type_transaction`) VALUES
(1, 88, 'a0ecd3b0-ddee-4cae-8d8a-220054708c84', 'ELECTION-88-1774697683558', 25, 'PENDING', '{\"titre\":\"MONTE ELECTION\",\"description\":\"AZERTYU\",\"type\":\"BINOMINAL\",\"startDate\":\"2026-03-28 13:00:00\",\"endDate\":\"2026-03-28 14:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-28 11:34:44', NULL, 'CREATION_ELECTION'),
(2, 89, 'f951042d-6f7b-4fda-bf97-3d791e9378b7', 'ELECTION-89-1774698972117', 25, 'SUCCESSFUL', '{\"titre\":\"Monstral Election\",\"description\":\"GDGDJD\",\"type\":\"UNINOMINAL\",\"startDate\":\"2026-03-28 14:00:00\",\"endDate\":\"2026-03-28 15:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-28 11:56:12', '2026-03-28 11:56:36', 'CREATION_ELECTION'),
(3, 90, '510f7d18-8336-4a33-96c7-56b7826157a6', 'ELECTION-90-1774797694669', 25, 'PENDING', '{\"titre\":\"ELECTION DU PRESIDENT\",\"description\":\"ERTYUIODKJHGHJKL \",\"type\":\"UNINOMINAL\",\"startDate\":\"2026-03-19 17:00:00\",\"endDate\":\"2026-03-29 21:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-29 15:21:35', NULL, 'CREATION_ELECTION'),
(4, 91, '9e314f3e-389b-484a-9241-75d10169dc6d', 'ELECTION-91-1774801844204', 25, 'PENDING', '{\"titre\":\"Election jury\",\"description\":\"DGHJKLLXHYUI\",\"type\":\"BINOMINAL\",\"startDate\":\"2026-03-29 20:00:00\",\"endDate\":\"2026-03-29 23:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-29 16:30:44', NULL, 'CREATION_ELECTION'),
(5, 92, 'f847a721-0e8e-4c5d-83a3-06395f44e907', 'ELECTION-92-1774802150724', 25, 'SUCCESSFUL', '{\"titre\":\"Election jury\",\"description\":\"DGHJKLLXHYUI\",\"type\":\"BINOMINAL\",\"startDate\":\"2026-03-29 20:00:00\",\"endDate\":\"2026-03-29 23:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-29 16:35:51', '2026-03-29 16:36:22', 'CREATION_ELECTION'),
(6, 95, 'b841e19a-3d46-48d8-a89e-7a9c6556ec31', 'ELECTION-95-1774858881895', 10, 'SUCCESSFUL', '{\"titre\":\"ELECTION MEMBRE\",\"description\":\"SDFGHJK\",\"type\":\"UNINOMINAL\",\"visibilite\":\"PUBLIC\",\"startDate\":\"2026-03-30 11:00:00\",\"endDate\":\"2026-03-30 14:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-30 08:21:22', '2026-03-30 08:21:47', 'CREATION_ELECTION'),
(7, 96, 'e59f4473-db72-4454-bfaf-a55d98940309', 'ELECTION-96-1774860206464', 10, 'SUCCESSFUL', '{\"titre\":\"TACKU ELECTION\",\"description\":\"RTYU\",\"type\":\"UNINOMINAL\",\"visibilite\":\"PUBLIQUE\",\"startDate\":\"2026-03-30 15:00:00\",\"endDate\":\"2026-03-30 18:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-03-30 08:43:27', '2026-03-30 08:43:54', 'CREATION_ELECTION'),
(8, 97, '84ab3e11-37c1-4d4d-b4ec-542a68ca6d26', 'ELECTION-97-1775154712436', 10, 'SUCCESSFUL', '{\"titre\":\"Election were\",\"description\":\"SHDHJD\",\"type\":\"UNINOMINAL\",\"visibilite\":\"PUBLIQUE\",\"startDate\":\"2026-04-04 15:00:00\",\"endDate\":\"2026-04-06 12:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-04-02 18:31:52', '2026-04-02 18:32:17', 'CREATION_ELECTION'),
(9, 98, 'd96c43f4-6723-48ca-8e55-4aad61538042', 'ELECTION-98-1775427195731', 10, 'SUCCESSFUL', '{\"titre\":\"MIX CAMEROUN\",\"description\":\"Election qui consiste a voter le meilleur mix du cameroun\",\"type\":\"UNINOMINAL\",\"visibilite\":\"PRIVE\",\"startDate\":\"2026-04-06 15:00:00\",\"endDate\":\"2026-04-08 12:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-04-05 22:13:16', '2026-04-05 22:13:41', 'CREATION_ELECTION'),
(10, 99, '600fb074-3ab2-4d8c-8574-c9d2be8152e1', 'ELECTION-99-1775427765179', 10, 'PENDING', '{\"titre\":\"MASTER CAMEROUN\",\"description\":\"Voter master du cameroun\",\"type\":\"UNINOMINAL\",\"visibilite\":\"PUBLIQUE\",\"startDate\":\"2026-04-07 14:00:00\",\"endDate\":\"2026-04-09 22:00:00\",\"dureeTourMinutes\":null,\"nbSieges\":null}', '2026-04-05 22:22:46', NULL, 'CREATION_ELECTION');

-- --------------------------------------------------------

--
-- Structure de la table `transaction_retrait`
--

DROP TABLE IF EXISTS `transaction_retrait`;
CREATE TABLE IF NOT EXISTS `transaction_retrait` (
  `id_retrait` int NOT NULL AUTO_INCREMENT,
  `superadmin_id` int NOT NULL,
  `campay_reference` varchar(100) NOT NULL,
  `external_reference` varchar(120) DEFAULT NULL,
  `montant` decimal(10,2) NOT NULL,
  `telephone` varchar(15) NOT NULL,
  `description` varchar(255) DEFAULT NULL,
  `statut` enum('PENDING','SUCCESSFUL','FAILED') DEFAULT 'PENDING',
...
--
-- Déchargement des données de la table `transaction_retrait`
--

INSERT INTO `transaction_retrait` (`id_retrait`, `superadmin_id`, `campay_reference`, `external_reference`, `montant`, `telephone`, `description`, `statut`, `date_creation`, `date_confirmation`) VALUES
(1, 84, 'DEMO-RETRAIT-1775455559630', 'RETRAIT-1775455559630', '100.00', '237655024817', NULL, 'PENDING', '2026-04-06 08:05:59', NULL),
(2, 84, 'DEMO-RETRAIT-1775456232725', 'RETRAIT-1775456232725', '100.00', '237655024817', 'Retrait du boss', 'SUCCESSFUL', '2026-04-06 08:17:12', '2026-04-06 08:17:17'),
(3, 84, 'DEMO-RETRAIT-1775659513408', 'RETRAIT-1775659513408', '100.00', '237697833505', NULL, 'SUCCESSFUL', '2026-04-08 16:45:13', '2026-04-08 16:45:18');
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `role` enum('SUPER_ADMIN','ADMIN_ELECTION','ELECTEUR','ADMIN_ELECTION_PENDING','CANDIDAT_PUBLIC') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ELECTEUR',
...
(93, 'RODRIGO', 'Alfred', 'rodrigo@gmail.com', '$2b$10$bVen/Ne07JK/k.nUuxhvkeoGX3W912lZ8ySEv19/l8oajgpjVk9Ga', 'ADMIN_ELECTION_PENDING', 1, '2026-03-30 02:55:24'),
(94, 'RODRIGO', 'Alfred', 'rodri@gmail.com', '$2b$10$t2XJZ.R937cUsTv/aLJUtuEitPrI30C/P.Y98bZmbqnHLso6FGbNK', 'ADMIN_ELECTION_PENDING', 1, '2026-03-30 02:56:19'),
(95, 'rodrick', 'artheru', 'rodrick@gmail.com', '$2b$10$nCVBwjmgSulwvwVD2cWOj.agTX2F//17jSvGdYOhxNMThRX9ssE2e', 'ADMIN_ELECTION', 1, '2026-03-30 08:21:19'),
(96, 'tanku', 'morgan', 'tanku@gmail.com', '$2b$10$KVqim5vQhlj76kNchNhKsew/W/OuSqIWZ1zEgayWpNvC8OEDSK/fa', 'ADMIN_ELECTION', 1, '2026-03-30 08:43:24'),
(97, 'inias', 'misard', 'inias@gmail.com', '$2b$10$PYB06FVO1odyYZuPCs/nfuXOpL4FAQumjWEGzKRXEUg0KM7elKgsO', 'ADMIN_ELECTION', 1, '2026-04-02 18:31:50'),
(98, 'fernando', 'torres', 'torres@gmail.com', '$2b$10$myaCqO4XPm1acxM3NrxEIOEACCBfslfBCbSxgvE9m4EK3JocxJwL.', 'ADMIN_ELECTION', 1, '2026-04-05 22:13:13'),
(99, 'gavi', 'alex', 'gavi@gmail.com', '$2b$10$AbhCGCn5CN0nu6U0Pha9nOb8kpTn/kLreAMxCG.8V7eFGfYRGRl..', 'ADMIN_ELECTION', 1, '2026-04-05 22:22:42'),
(100, 'pedro', 'liner', 'pedro@gmail.com', '$2b$10$y6GPiMiMVDCgWIPkmHwLjuwMGQNwfBHsoWeNH301XUd6VczavorUO', 'CANDIDAT_PUBLIC', 1, '2026-04-06 00:17:22');
...
--
-- Structure de la table `vote_public`
--

DROP TABLE IF EXISTS `vote_public`;
CREATE TABLE IF NOT EXISTS `vote_public` (
  `id` int NOT NULL AUTO_INCREMENT,
  `election_id` int NOT NULL,
  `candidat_public_id` int NOT NULL,
  `telephone_electeur` varchar(20) NOT NULL COMMENT 'Identifiant de l électeur',
  `nom_electeur` varchar(150) DEFAULT NULL,
  `email_electeur` varchar(255) DEFAULT NULL,
  `campay_reference` varchar(100) DEFAULT NULL,
  `statut_paiement` enum('EN_ATTENTE','PAYÉ','ECHEC') NOT NULL DEFAULT 'EN_ATTENTE',
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `candidat_public_id` (`candidat_public_id`),
  KEY `idx_vote_public_election` (`election_id`),
  KEY `idx_vote_public_telephone` (`telephone_electeur`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

--
-- Déchargement des données de la table `vote_public`
--

INSERT INTO `vote_public` (`id`, `election_id`, `candidat_public_id`, `telephone_electeur`, `nom_electeur`, `email_electeur`, `campay_reference`, `statut_paiement`, `created_at`) VALUES
(3, 43, 1, '237655024817', NULL, NULL, 'ad1b15ff-3f6e-4d78-a959-95bbc092944a', 'PAYÉ', '2026-04-06 01:14:55'),
(7, 47, 4, '237655024817', NULL, NULL, '37a705e8-49d5-4217-b88d-60b5eb8f09d6', 'EN_ATTENTE', '2026-04-08 01:29:40'),
(8, 47, 4, '237655024817', NULL, NULL, 'e4c9a734-ebd7-4374-9fc9-17303ff3edaf', 'EN_ATTENTE', '2026-04-08 14:50:28');
